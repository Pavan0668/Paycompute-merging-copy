...
namespace iEmpPower.UI.Manager_Self_Service
{
    public partial class AddEmpScore : System.Web.UI.Page
    {
        ...
        protected void btn_add_modnsub_Click(object sender, EventArgs e)
        {
        ...
        //        foreach (GridViewRow gr in GV_allmodules.Rows)
        //        {
        //            if (gr.Cells[3].Text == null)
        //            {
        //                gr.Cells[3].Text = "ADMIN";
        //            }

        //            if (gr.Cells[4].Text == null)
        //            {
        //                gr.Cells[4].Text = "ADMIN";
        //            }
        //        }
        //    }
        //    catch (Exception ex)
        ...
        //    }
                ...
                //TableCell Mcreatedby = e.Row.Cells[3];
                //if (Mcreatedby.Text == null)
                //{
                //    Mcreatedby.Text = "ADMIN";
                //}

                //TableCell Screatedby = e.Row.Cells[4];
                //if (Screatedby.Text == null)
                //{
                //    Screatedby.Text = "ADMIN";
                //}
