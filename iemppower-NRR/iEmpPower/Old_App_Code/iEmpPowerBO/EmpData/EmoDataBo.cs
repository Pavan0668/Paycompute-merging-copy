...
public class EmoDataBo
{
    public EmoDataBo() { }
    public decimal? depitid { get; set; }
    ...
    public string PF_Number_Dept_File { get; set; }
    public string Restrict_PF { get; set; }
    public string Zero_Pension { get; set; }
    public string Zero_PT { get; set; }
