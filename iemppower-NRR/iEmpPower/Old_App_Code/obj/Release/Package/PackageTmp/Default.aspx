...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
   ...
   <div>
    ...
    <div class="clear"></div>
        ...
        <cc1:TabContainer ID="tcDefalut" runat="server" ActiveTabIndex="0" 
...
<div>
    ...
    <asp:Label ID="lblNoteForApprover" runat="server" Text="Note for approver" 
       ...
       <br />
        <asp:Label ID="lblLRComments" runat="server" Text="Note for employee" CssClass="label" 
                     ></asp:Label>  
     ...
     <br />
        ...
        <div>
            <asp:Panel ID="pnlCheckList" runat="server" Visible="false">
                    <h3 style="font-weight: bold">Pending List</h3>
                <br />
   <%-- <table class="ticket-info">
        <tr>
            <td>--%>
                <asp:Label ID="Label3" runat="server" Text="Requisitions to Approve : " Font-Bold="True" CssClass="label-big"></asp:Label>
               <asp:Label ID="lblRequisitionsToApproveC" runat="server" Text="" CssClass="label-big"></asp:Label>
               <br />
                    <asp:Label ID="Label4" runat="server" Text="Local Accommodation Requisitions : " Font-Bold="True" CssClass="label-big"></asp:Label>
                    <asp:Label ID="lblLocalAccReqC" runat="server" Text="" CssClass="label-big"></asp:Label>
                <br />
                    <asp:Label ID="Label8" runat="server" Text="Local Vehicle Requisitions : " Font-Bold="True" CssClass="label-big"></asp:Label>
                    <asp:Label ID="lblLocalVehiReqC" runat="server" Text="" CssClass="label-big"></asp:Label>
                <br />
                    <asp:Label ID="Label5" runat="server" Text="Outstation Accommodation Requisitions : " Font-Bold="True" CssClass="label-big"></asp:Label>
                    <asp:Label ID="lblOutAccReqC" runat="server" Text="" CssClass="label-big"></asp:Label>
                <br />
                    <asp:Label ID="Label9" runat="server" Text="Outstation Vehicle Requisitions : " Font-Bold="True" CssClass="label-big"></asp:Label>
                    <asp:Label ID="lblOutVehiReqC" runat="server" Text="" CssClass="label-big"></asp:Label>
                <br />
                    <asp:Label ID="Label6" runat="server" Text="Ticket Booking : " Font-Bold="True" CssClass="label-big"></asp:Label>
                    <asp:Label ID="lblTicketBookingC" runat="server" Text="" CssClass="label-big"></asp:Label>
                <br />
                    <asp:Label ID="Label11" runat="server" Text="Ticket Booking Vehicle/Accommodation : " Font-Bold="True" CssClass="label-big"></asp:Label>
                    <asp:Label ID="lblTicketAccVehiC" runat="server" Text="" CssClass="label-big"></asp:Label>
                <br /> 
          <%--  </td>  
        </tr>
    </table>--%>
    ...
    <br />
   <div>
      <asp:Panel ID="upPnlVisa" runat="server" Visible="false"> 
            <br />
            <h3>Visa/Passport Expiry Details</h3>
            <br />
            <asp:GridView ID="grdVisaPassportExpiry" runat="server" CssClass="gridview" AutoGenerateColumns="False"  Width="100%">
            <Columns> 
                 <asp:BoundField DataField="PERNR" HeaderText="PERNR"  />
                 <asp:BoundField DataField="ICTYPE" HeaderText="ICTYPE" ReadOnly="True" />
                 <asp:BoundField DataField="ICNUM" HeaderText="ICNUM" ReadOnly="True"  />
                 <asp:BoundField DataField="ENDDA" HeaderText="ENDDA" ReadOnly="True"  />
            </Columns>
         </asp:GridView> 
          <br />
            <div>
                <asp:HyperLink ID="HyperLink1" runat="server" Target="_blank" NavigateUrl="http://www.indianrail.gov.in/">Indian Railways</asp:HyperLink>
            </div>
            <br />
            <div>
                <asp:HyperLink ID="HyperLink2" runat="server" Target="_blank" NavigateUrl="http://www.cleartrip.com/">Flight Details</asp:HyperLink>
            </div>
            <br />
            <div>
                <asp:HyperLink ID="HyperLink3" runat="server" Target="_blank" NavigateUrl="http://www.ksrtc.in/">Bus booking</asp:HyperLink>
            </div>
          <br />
         </asp:Panel>
    </div>
