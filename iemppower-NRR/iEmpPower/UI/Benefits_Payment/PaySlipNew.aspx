<%@ Page Title="PaySlip" Language="C#" MasterPageFile="~/UI/SubSiteMaster.master" AutoEventWireup="true" CodeBehind="PaySlipNew.aspx.cs"
    Inherits="iEmpPower.UI.Benefits_Payment.PaySlipNew" Culture="auto" MaintainScrollPositionOnPostback="true"
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">All Employees Payslip</li>
                    </ol>
                </div>
                <h4 class="page-title">All Employees Payslip
            ...
            <div id="divbrdr" class="divfr">
                <div class="search-section">
                            ...
                            <div>
                                ...
                                <div class="form-inline">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2 htCr"> Year&nbsp;<b>:</b>
                                        </div>
                                        <div class="col-sm-3">
                       ...
                       <div class="col-sm-3">
                                    ...
                                    <asp:Button ID="btnGeneratePaySlip" runat="server" Text="View payslip" OnClientClick="clearDirty();" TabIndex="3" OnClick="btnGeneratePaySlip_Click"/>
                                </div>
                            </div>
                        </div>
