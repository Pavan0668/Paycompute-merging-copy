...
{
    public partial class Local_Vehi_TicketBook : System.Web.UI.Page
    {
        ...
        void loadlocaltravelrequisitiondetails()
        {
            ...
            objlist = objbl.Get_Local_travel_Details(selectedvalue, empno,"8");
        ...
        void ClearControl()
        {
            ...
            txtTotalCost.Text = "";
            txtTotalKm.Text = "";
            pnlVehiTicketbooking.Visible = false;
        }
        ...
        protected void btnAccept_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int result = objbl.Create_Vehicle_ticket_booking_details(objbo);
                if (result == 0)
                {
        ...
        protected void btnSendToTD_Click(object sender, EventArgs e)
        {
            try
            {
                //if (Session["RequisitionSelectedID"] != null)
                ...
                ticketbookingVehicollectionbo objcollectionbo = new ticketbookingVehicollectionbo();
                ticketbookingbl objbl = new ticketbookingbl();
                objbo.Vehicle_req_id = Convert.ToInt32(Session["LOCAL_TRAVEL_REQUISITION_ID"]);
                objbo.REQUISITION_ID = Convert.ToInt32("0");
                objbo.REQ_SEGMENT_ID = Convert.ToInt32("0");
                objbo.PROPOSAL_ID = Convert.ToInt32("0");
                objbo.PRO_SEGMENT_ID = Convert.ToInt32("0");
                ...
                objbo.modified_by = User.Identity.Name;
                objbo.modified_on = System.DateTime.Now;
                objbo.CurrentStatus = "Proposal";

                int result = objbl.Create_Vehicle_ticket_booking_details(objbo);
                if (result == 0)
                {
                    lblMessageBoard.ForeColor = System.Drawing.Color.Green;
                    lblMessageBoard.Text = "Ticket booking send to Travel Desk successfully";
                    loadlocaltravelrequisitiondetails();
                    SendMail();
                }
                else
