<%@ Page Title="" Language="C#" MasterPageFile="~/UI/SubSiteMaster.master" AutoEventWireup="true" CodeBehind="EmployeesPayslip.aspx.cs" MaintainScrollPositionOnPostback="true"
    Inherits="iEmpPower.UI.Payroll_Management.EmployeesPayslip" Culture="en-GB" UICulture="auto" Theme="SkinFile" %>
   ...
   <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Employee's Payslip</li>
                    </ol>
                </div>
                <h4 class="page-title">Employee's Payslip
            ...
            <div id="real_time_chart" class="dashboard-flot-chart">
                 <div class="row">
                    <div class="col-sm-2 htCr">Employee ID</div>
                      <div class="col-sm-6">
                            <asp:DropDownList ID="DDL_Empname_payslip" runat="server" CssClass="txtDropDownwidth">
                            </asp:DropDownList>
                           </div>
                     </div>
                <br />
                    ...
                    <div class="col-sm-2 htCr">Year</div>
                        <div class="col-sm-6">
                            <asp:DropDownList ID="drpdwnYear" runat="server" CssClass="txtDropDownwidth" meta:resourcekey="drpdwnYearResource1">
                    ...
                    <div class="col-sm-2 htCr">Month</div>
                        <div class="col-sm-6">
                            <asp:DropDownList ID="drpdwnMonth" runat="server" CssClass="txtDropDownwidth" meta:resourcekey="drpdwnMonthResource1">
