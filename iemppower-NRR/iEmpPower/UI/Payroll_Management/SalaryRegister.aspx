<%@ Page Title="" Language="C#" MasterPageFile="~/UI/SubSiteMaster.master" AutoEventWireup="true" CodeBehind="SalaryRegister.aspx.cs" MaintainScrollPositionOnPostback="true"
    Inherits="iEmpPower.UI.Payroll_Management.SalaryRegister" Culture="en-GB" UICulture="auto" Theme="SkinFile" %>
   ...
   <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Salary Register
                       ...
                       <div class="col-sm-3">
                        <asp:DropDownList ID="drpdwnMonth" runat="server" CssClass="txtDropDownwidth">
                            ...
                            <asp:ListItem Value="12" meta:resourcekey="ListItemResource15">December</asp:ListItem>
                                ...
                                <asp:Button ID="btngenerate" runat="server" Text="View Report" OnClientClick="clearDirty();" OnClick="btngenerate_Click"/>
                                </div>
                           </div>
                    </div>
