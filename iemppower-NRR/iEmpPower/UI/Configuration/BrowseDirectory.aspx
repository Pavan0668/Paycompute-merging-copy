<%@ Page Language="C#" AutoEventWireup="true" Inherits="BrowseDirectory" Codebehind="BrowseDirectory.aspx.cs" %>
        ...
        <div>
            <table width="100%" border="0">
               ...
               <tr>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="_browseTextBox" runat="server" CssClass="toolbar" Width="300px" /><asp:ImageButton ID="_browseButton" ImageUrl="~/ImagesFiles/Go.gif" runat="server" OnClick="_browseButton_Click" />
                    </td>
                </tr>
                <tr>
                    <td>
                                ...
                                <tr>
                                    <td>
                                            ...
                                            <asp:TreeView ID="TreeView1" runat="server" Height="326px" ImageSet="XPFileExplorer"
                                                ...
                                                <LeafNodeStyle ImageUrl="~/ImagesFiles/folder.gif" />
                                            </asp:TreeView>
                 ...
                 <tr>
                    <td align="left">
                        ...
                        <asp:ImageButton ID="_selectButton" ImageUrl="~/ImagesFiles/ok.jpg" OnClientClick="SelectAndClose();"
                            runat="server" />
                    </td>
                </tr>
            </table>
