<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RRF_All_Req.aspx.cs" Inherits="iEmpPower.UI.RRF.RRF_All_Req" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="header">
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-6">
                <span class="HeadFontSize">&nbsp;R.R.F Status</span><br />
            </div>
        </div>
    ...
    <div class="body">
        <div class="divfr" id="divbrdr">
            ...
            <asp:UpdatePanel runat="server" ID="upapp_rej">
                <ContentTemplate>
                            ...
                            <div class="form-group">
                                <div class="col-sm-8">
                                    ...
                                    <div class="col-sm-4">
                                      ...
                                      <div class="col-sm-2">
                                    <asp:Button ID="btnSearchClear" runat="server" Text="Clear" OnClick="btnSearchClear_Click" /></div>
                                </div>


                                <%--<div class="col-sm-4">
                                    <div id="divreqType" runat="server" class="">
                                        <div class="">
                                            <div class="">
                                                <div class="col-sm-6 htCr Cntrlwidth">
                                                    Request Type :
                                                </div>
                                                <div class="col-sm-6">
                    ...
                    <div style="position: relative; float: right; right: 15px; top: 5px">
                        <asp:Button ID="BtnEdit" runat="server" Text="&laquo; Edit" CausesValidation="false" OnClick="BtnEdit_Click1" />

                        <%--<asp:Button ID="btnRRF_req_close" Width="30px" CausesValidation="false" runat="server" Text=" &times; " />--%>
                    </div>
                    <asp:FormView ID="FV_RRF_MyReq" PagerStyle-CssClass="pager" runat="server" AllowPaging="true" ForeColor="WhiteSmoke" OnPageIndexChanging="FV_RRF_MyReq_PageIndexChanging"
                        OnItemCommand="FV_RRF_MyReq_ItemCommand1"
      ...
      MIN_EDU_QLAFTN,MIN_CERTIFNTN,TOT_EXP,TOT_DOMAIN_EXP,AREA_EXPRTSE,OTHER_SPC_REQ,JOB_DISP,DISP_FILE,
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-inline">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 formtext_">
                                        <%# Eval("JOB_DISP")%>
                                        <%--<asp:Button ID="btndwld" runat="server" OnClick="lnkDwnldjobDisp_Click"/>--%>
                                        <asp:HiddenField ID="HF_jobDisp" Value='<%# Eval("DISP_FILE")%>' runat="server" />
                                        <%--<asp:LinkButton ID="lnkDwnldjobDisp" OnClick="lnkDwnldjobDisp_Click" runat="server" Text="[ Download ]" Visible='<%#Eval("DISP_FILE").ToString()==""?false:true %>'></asp:LinkButton>--%>
                            ...
                            <div class="col-sm-12" style="padding: 10px 0">
                                <div class="col-sm-10 respovrflw" style="">
                                    <table class="gridview respovrflw" style="border: inset 2px WhiteSmoke; color: #00617C !important">
                                ...
                                <%--  <asp:Panel ID="divAppRej" runat="server" class="col-sm-4">
                ...
                <Triggers>
                    <%--<asp:AsyncPostBackTrigger ControlID="rbtnReqTypeStatus" />--%>
                    <asp:PostBackTrigger ControlID="FV_RRF_MyReq" />
                    <%--<asp:PostBackTrigger ControlID="GRD_RRF" />--%>
