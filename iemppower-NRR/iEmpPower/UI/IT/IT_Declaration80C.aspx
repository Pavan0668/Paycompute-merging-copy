<%@ Page Title="" Language="C#" MasterPageFile="~/UI/SubSiteMaster.master" AutoEventWireup="true" CodeBehind="IT_Declaration80C.aspx.cs"
     Inherits="iEmpPower.UI.IT.IT_Declaration80C" Theme="SkinFile" EnableEventValidation="false" Culture="en-GB"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div id="DivSec80C" runat="server">
        <h2>Section 80 C Deductions : From April 1<sup>st</sup> <asp:Label ID="LblFromDate" runat="server"></asp:Label> To March 31<sup>st</sup> <asp:Label ID="LblToDate" runat="server"></asp:Label></h2>
     ...
     <%--    <div id="Div1" runat="server" style="width:60%;">
         ...
         <%-- <asp:Panel ID="PnlIT" runat="server" Width="90%" Height="360px">--%>
           <asp:GridView ID="GVITSec80C" runat="server" AutoGenerateColumns="False"  BorderStyle="None" Width="85%" DataKeyNames="ICODE,ID,LID"
                ...
                <Columns>
                   <%-- //select t8.SBSEC,t8.SBDIV,t8.SBDDS, t9.SDVLT,t9.TXEXM--%>
                    ...
                    <asp:TemplateField HeaderText="Prop. Invst. (INR)">
                        <ItemStyle HorizontalAlign="right"/>
                        <ItemTemplate>
                            <asp:TextBox ID="txtPropContr" runat="server" Style="text-align: right" CssClass="textbox" Width="100px" Text='<%# Eval("PROPINVST") %>'></asp:TextBox>
                     ...
                     <asp:TemplateField HeaderText="Act. Invst. (INR)">
                        <ItemStyle HorizontalAlign="right"/>
                        <ItemTemplate>
                            <asp:TextBox ID="txtActContr" runat="server" Style="text-align: right" CssClass="textbox"  Width="100px" Text='<%# Eval("ACTINVST") %>'></asp:TextBox>
                         <cc1:FilteredTextBoxExtender ID="FTB_txtActContr" runat="server" FilterMode="ValidChars" FilterType="Custom,Numbers"
                                    TargetControlID="txtActContr" ValidChars="."></cc1:FilteredTextBoxExtender>
                             </ItemTemplate>
                    </asp:TemplateField>
                  <%--  <asp:BoundField HeaderText="Curr"  DataField="CURR">
                    ...
                    <asp:TemplateField HeaderText="Remarks">
                        ...
                        <ItemTemplate>
                            <asp:TextBox ID="txtRemarks" runat="server" Style="text-align: right" TextMode="MultiLine" Width="170px" Text='<%# Eval("EMPCOMMENTS") %>'></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="right" />
                    </asp:TemplateField>
                    </Columns>
