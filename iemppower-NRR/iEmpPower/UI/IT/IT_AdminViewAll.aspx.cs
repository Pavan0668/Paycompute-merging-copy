...
{
    public partial class IT_AdminViewAll : System.Web.UI.Page
    {
        ...
        private void LoadSec80()
        {
            try
            {
                ...
                ITboObj1 = ITblObj.Load_IT_HistoryForAdmin(flag);
            ...
            try
            {
                switch (e.CommandName.ToUpper())
                {
                    case "VIEW":
                        ...
                        ViewState["SEC80CCREATEDBY"] = GVSec80CHeader.DataKeys[int.Parse(e.CommandArgument.ToString())]["CREATED_BY"].ToString().Trim();
                        ViewState["SEC80CENAME"] = GVSec80CHeader.DataKeys[int.Parse(e.CommandArgument.ToString())]["ENAME"].ToString().Trim();
            ...
            try
            {
                switch (e.CommandName.ToUpper())
                {
                   ...
                   System.Drawing.Color.White;
                        ...
                        int nxtid = GVOthersHeader.DataKeys[int.Parse(e.CommandArgument.ToString())]["CONACTPROP"].ToString() == "-" ? 0 : int.Parse(GVOthersHeader.DataKeys[int.Parse(e.CommandArgument.ToString())]["CONACTPROP"].ToString()); ViewState["ITOTHERSID"] = int.Parse(GVOthersHeader.DataKeys[int.Parse(e.CommandArgument.ToString())]["ID"].ToString());
                        ...
                        ViewState["OTHERSCREATEDBY"] = GVOthersHeader.DataKeys[int.Parse(e.CommandArgument.ToString())]["CREATED_BY"].ToString().Trim();
                        ViewState["OTHERSENAME"] = GVOthersHeader.DataKeys[int.Parse(e.CommandArgument.ToString())]["ENAME"].ToString().Trim();
        ...
        public void search()
        {
            try
            {
                ...
                else
                {
                    ...
                    List<ITbo> ITboObj = new List<ITbo>();
                    List<ITbo> ITboObj1 = new List<ITbo>();
                    ITboObj1 = ITblObj.Load_ParticularITForAdmin(SelectedType, textSearch, FromDate, ToDate, int.Parse(HFTabID.Value.ToString().Trim()));
        ...
        protected void BtnExporttoXlSec80_Click(object sender, EventArgs e)
        {
            try
            {
                GVITSec80.GridLines = GridLines.Both;
                GVSec80Header.GridLines = GridLines.Both;
                ExportToExcelSec80();
                txtsearch.Focus();
            }
            catch (Exception Ex)
        ...
        public void ExportToExcelSec80()
        {
            try
            {
                ...
                else
                {
                    ...
                    search();
                    GVSec80Header.Columns[12].Visible = false;
                    ...
                    GVSec80Header.Columns[12].Visible = true;
        ...
        protected void BtnExptoXLSEC80C_Click(object sender, EventArgs e)
        {
            try
            {
                GVITSec80C.GridLines = GridLines.Both;
                GVSec80CHeader.GridLines = GridLines.Both;
                ExportToExcelSec80C();
                txtsearch.Focus();
            }
            catch (Exception Ex)
        ...
        public void ExportToPdfSec80C()
        {
            try
            {
                ...
                else
                {
                    ...
                    search();
                    GVSec80CHeader.Columns[12].Visible = false;
                    ...
                    GVSec80CHeader.Columns[12].Visible = true;
        ...
        protected void BtnExptoXLHousing_Click(object sender, EventArgs e)
        {
            try
            {
                GVHousing.GridLines = GridLines.Both;
                GVHousingHeader.GridLines = GridLines.Both;
                ...
                else
                {
                    ...
                    search();
                    GVHousingHeader.Columns[11].Visible = false;
                    ...
                    GVHousingHeader.Columns[11].Visible = true;
        ...
        protected void BtnExptoXLOthers_Click(object sender, EventArgs e)
        {
            try
            {
                if (viewcheckOthers.Value == "YES")
                {
                    ...
                    string colHeads = "IT Declaration Others Details";
                    htw.WriteEncodedText(colHeads);


                    if (ViewState["ITOTHERSTYP"].ToString().Trim() == "1")
                    {
                        grdSelfOccDetails.GridLines = GridLines.Both;
                        grdBorwDetails.GridLines = GridLines.Both;
                        GVOthers1.GridLines = GridLines.Both;
                        grdSelfOccDetails.RenderControl(htw);
                        ...
                        grdBorwDetails.RenderControl(htw);
                    }
                    ...
                    renderedGridView += sw.ToString() + "<br/>";
                    Response.AppendHeader("content-disposition", "attachment; filename=" + "Summary_Report" + "_IncomeTax_Others_Details.xls");
                    Response.ContentType = "Application/vnd.ms-excel";
                    Response.Write(renderedGridView);
                    Response.End();
                }
                else
                {
                    ...
                    search();
                    GVOthersHeader.Columns[11].Visible = false;
                    ...
                    GVOthersHeader.Columns[11].Visible = true;
                    ...
                    // renderedGridView = "Summary_Report" + "<br>"; //+ sw.ToString();
                    string renderedGridView = "IT Declaration Others Details <br/>";
                    renderedGridView += sw.ToString() + "<br/>";
                    Response.AppendHeader("content-disposition", "attachment; filename=" + "Summary_Report" + "_IncomeTax_Others_Details.xls");
                    Response.ContentType = "Application/vnd.ms-excel";
                    Response.Write(renderedGridView);
        ...
        protected void BtnExptopdfOthers_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Response.ContentType = "application/pdf";
                    Response.AddHeader("content-disposition", "attachment;filename=" + "Summary_Report" + "_IncomeTax_Others_Details.pdf");
                    Response.Cache.SetCacheability(HttpCacheability.NoCache);
                    ...
                    if (ViewState["ITOTHERSTYP"].ToString().Trim() == "1")
                    {
                        grdSelfOccDetails.GridLines = GridLines.Both;
                        grdBorwDetails.GridLines = GridLines.Both;
                        grdSelfOccDetails.RenderControl(h_textw);
                        GVOthers1.GridLines = GridLines.Both;
                        if (ViewState["TypeRENTO"].ToString() == "3")
                        {
                            GVOthers1.RenderControl(h_textw);
                        }
                        grdBorwDetails.RenderControl(h_textw);
        ...
        protected void btnPreInExprtXl_Click(object sender, EventArgs e)
        {
            try
            {
                grdPreEmptInc.GridLines = GridLines.Both;
                grdPreEmptIncHead.GridLines = GridLines.Both;
                if (HFPreInExprt.Value == "YES")
                {
                    System.IO.StringWriter sw = new System.IO.StringWriter();
                    System.Web.UI.HtmlTextWriter htw = new System.Web.UI.HtmlTextWriter(sw);
                    ...
                    string colHeads = "IT Declaration Previous Employment Details";
                    htw.WriteEncodedText(colHeads);
                    ...
                    // renderedGridView = "Summary_Report" + "<br>"; //+ sw.ToString();
                    string renderedGridView = "IT Declaration Previous Employment Details <br/>";
                    ...
                    //renderedGridView += "<tr><td align=left>Status</td><td align=left>:</td><td align=left>" + ViewState["OTHERSSTS"].ToString() + "</td></tr></table>";
                    renderedGridView += sw.ToString() + "<br/>";
                    Response.AppendHeader("content-disposition", "attachment; filename=" + "Summary_Report" + "_IncomeTax_Previous_Employment_Details.xls");
                    Response.ContentType = "Application/vnd.ms-excel";
                    Response.Write(renderedGridView);
                    Response.End();
                }
        ...
        protected void btnPreInExprtPDF_Click(object sender, EventArgs e)
        {
            try
            {
                grdPreEmptInc.GridLines = GridLines.Both;
                ...
                {
                    Response.ContentType = "application/pdf";
                    Response.AddHeader("content-disposition", "attachment;filename=" + "Summary_Report" + "_IncomeTax_Previous_Employment_Details.pdf");
                    Response.Cache.SetCacheability(HttpCacheability.NoCache);
            ...
            try
            {
                switch (e.CommandName.ToUpper())
                {
                    case "VIEW":
                        ...
                        ViewState["ITHOUSINGTYP"] = "Section 80 C";
                        ...
                        ViewState["HOUSINGCREATEDBY"] = GVHousingHeader.DataKeys[int.Parse(e.CommandArgument.ToString())]["CREATED_BY"].ToString().Trim();
                        ViewState["HOUSINGENAME"] = GVHousingHeader.DataKeys[int.Parse(e.CommandArgument.ToString())]["ENAME"].ToString().Trim();
