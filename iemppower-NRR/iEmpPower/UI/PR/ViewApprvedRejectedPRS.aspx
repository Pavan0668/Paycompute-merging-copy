<%@ Page Title="" Language="C#" MasterPageFile="~/UI/SubSiteMaster.master" AutoEventWireup="true" CodeBehind="ViewApprvedRejectedPRS.aspx.cs" Inherits="iEmpPower.UI.PR.ViewApprvedRejectedPRS"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="ViewPRIfo" runat="server" visible="false">
        <h2>Requisition Details</h2>
        <Ajx:TabContainer ID="DisplayPRInfo" runat="server" Width="100%" ActiveTabIndex="2" TabIndex="6">
