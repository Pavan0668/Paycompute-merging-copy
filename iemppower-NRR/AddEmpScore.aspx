           ...
           <div>
             <span class="HeadFontSize" style="margin-left:10px">&nbsp;Add Scores
                ...
                <div style="float:right;margin-right:25px">
                 <asp:LinkButton ID="lnk_view" runat="server" CssClass="lnkclass" OnClick="lnk_view_Click">View</asp:LinkButton>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="background-color: #f4f8f9; font-family: verdana; font-size: 8pt; height: 25px; text-align: center">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="txtmonth_cldr" CssClass="txtscore" runat="server" ValidationGroup="add" TabIndex="4" AutoPostBack="true"></asp:TextBox>
                              ...
                              <div class="respovrflw" style="max-height:350px;">
                                    <asp:GridView ID="gv_Viewscores" EmptyDataText="No Records found" runat="server" OnPageIndexChanging="gv_Viewscores_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="SCORE" HeaderText="Scores" ItemStyle-HorizontalAlign="Center" />
                                            <asp:BoundField DataField="REMARKS" HeaderText="Remarks" />
                                              <asp:BoundField DataField="For_month" HeaderText="For the month of" />
                                             <asp:BoundField  DataField="Created_By" HeaderText="Created-By"/>
                                            <asp:BoundField DataField="Created_On" HeaderText="Assessment-Date" ItemStyle-HorizontalAlign="Center" />
                                        </Columns>
                                    </asp:GridView>
                                  </div>
                                    <br />
             ...
             <span class="HeadFontSize" style="margin-left:5px">&nbsp;Add Modules And Sub Modules
               ...
               <div class="Fr">
                ...
                <table>
                    <tr>
                        <td>
                        <asp:LinkButton ID="LK_backtomodlpg" runat="server" CssClass="lnkclass" Text="Back" OnClick="LK_backtomodlpg_Click"></asp:LinkButton>
               </td>
                        <%--<td>
                            <p class="paddingstyl">&nbsp;| &nbsp;</p>
                        </td>
                        <td>
                            <asp:LinkButton ID="LK_exit" runat="server" CssClass="lnkclass" Text="Exit" OnClick="LK_exit_Click"></asp:LinkButton>
                             </td>--%>
                         <td>
                            <p class="paddingstyl">&nbsp;| &nbsp;</p>
                        </td>
                        <td>
                            <asp:LinkButton ID="LK_viewallmods" runat="server" Text="View" OnClick="LK_viewallmods_Click"></asp:LinkButton>
                        </td>
                    </tr>
                </table>
                   </div>
                        ...
                        <asp:LinkButton ID="LK_backfrmvw" runat="server" CssClass="lnkclass" Text="Back" OnClick="LK_backfrmvw_Click"></asp:LinkButton>
                             ...
                             <div class="body">
                                 <asp:GridView ID="GV_allmodules" runat="server" EmptyDataText="No Records found"  OnPageIndexChanging="GV_allmodules_PageIndexChanging"
                                     ...
                                     SbCreated_By,mod_modifiedby,submod_modifiedby">
                                     <Columns>
                                         ...
                                         <%--<asp:BoundField DataField="MID" />
                                         <asp:BoundField DataField="SID" />OnRowDataBound="GV_allmodules_RowDataBound"--%>
                                         ...
                                         <asp:TemplateField HeaderText="Sub Modules">
                                             <ItemTemplate>
